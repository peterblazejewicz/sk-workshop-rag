...
- A local LLM (LM Studio or Ollama) running with an OpenAI-compatible endpoint (e.g., http://127.0.0.1:1234/v1). For local servers, apiKey can typically be null/any string. Ensure the base URL includes /v1.
